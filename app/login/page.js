  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0B0B0B' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-14 relative overflow-hidden"
        ...
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 20% 60%, rgba(255,106,0,0.05) 0%, transparent 55%)', pointerEvents: 'none' }} />

        <div className="relative z-10 flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: '#FF6A00' }}>
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-display text-5xl font-bold text-white leading-[1.1] mb-5">
            Financial<br />excellence<br /><span style={{ color: '#FF6A00' }}>redefined.</span>
          </h1>
        ...
        <div className="relative z-10 grid grid-cols-3 gap-3">
          {[{ v: '$2.4B+', l: 'Managed' }, { v: '2FA', l: 'Protected' }, { v: '256-bit', l: 'Encrypted' }].map(s => (
              ...
              <form onSubmit={handleCredentials} className="space-y-4">
                <div>
                  ...
                  <input type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })}
                    className="inp px-4 py-3.5 rounded-xl text-sm" placeholder="you@example.com" required />
                </div>
                <div>
                  ...
                  <div className="flex justify-end mt-2">
                    <Link href="/forgot-password" className="text-xs transition" style={{ color: 'rgba(255,106,0,0.6)' }}>
                      Forgot password?
                    </Link>
                  </div>
                </div>
          ...
          {step === 'otp' && (
            <>
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold tracking-widest mb-2" style={{ color: 'rgba(255,255,255,0.35)' }}>
                    VERIFICATION CODE
                  </label>
                  <input
                    type="text"
